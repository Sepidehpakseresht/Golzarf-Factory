  ...
  <section className="hero-video relative h-screen overflow-hidden rounded-b-3xl shadow-lg">
    ...
    <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="flex flex-col items-center text-center text-white max-w-4xl mx-auto px-4">
        ...
        <button className="bg-[#3C71ED] hover:bg-blue-700 hover:-translate-y-1 hover:shadow-xl text-white font-bold py-4 px-8 mt-10 rounded-lg text-lg transition-all duration-300 flex items-center gap-2">
          مشاهده ی محصولات
